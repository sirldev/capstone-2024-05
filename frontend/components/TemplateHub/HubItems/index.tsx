  ...
  const tempHubItems = [
    {
      ...
      userName: 'Ivy',
      hashtags: 'Amazon S3|AWS Logging',
    },
    {
      id: 12,
      prompt:
      ...
      userName: 'Charlie',
      hashtags: 'Amazon DynamoDB|Amazon S3',
    },
    {
      id: 13,
      prompt:
    ...
    },
    {
      ...
      userName: 'Eve',
      hashtags: 'API Gateway|AWS Lambda',
    },
    {
      id: 16,
      prompt: 'EBS 볼륨 하나 만들어줘. 50GB gp3 타입이고, 암호화도 활성화해줘.',
      userName: 'Frank',
      hashtags: 'Amazon EBS|AWS Security',
    },
    {
      id: 17,
      prompt:
      ...
      userName: 'Grace',
      hashtags: 'AWS Auto Scaling|Amazon EC2',
    },
    {
      id: 18,
      prompt:
    ...
    },
    {
      ...
      userName: 'Ivy',
      hashtags: 'Amazon CloudWatch|AWS Monitoring',
    },
    {
      id: 20,
      prompt:
    ...
    },
    {
      ...
      userName: 'Ivy',
      hashtags: 'Amazon RDS|PostgreSQL',
    },
    {
      id: 22,
      prompt:
      ...
      userName: 'Hank',
      hashtags: 'Amazon ElastiCache|Redis',
    },
    {
      id: 23,
      prompt:
    ...
    },
    {
      ...
      userName: 'Charlie',
      hashtags: 'Amazon CloudFront|Amazon S3',
    },
    {
      id: 25,
      prompt:
        "AWS KMS를 사용해서 새로운 키 생성해줘. 사용 목적은 '데이터 암호화'로 설정해.",
      userName: 'Diana',
      hashtags: 'AWS KMS|Security',
    },
    {
      id: 26,
      prompt:
        "AWS Fargate를 사용하여 컨테이너화된 애플리케이션 배포해줘. Docker 이미지는 'myimage:latest'로 설정해.",
      userName: 'Bob',
      hashtags: 'AWS Fargate|Docker',
    },
    {
      id: 27,
      prompt:
      ...
      userName: 'Alice',
      hashtags: 'Amazon SageMaker|Amazon S3',
    },
    {
      id: 28,
      prompt:
        'Amazon FSx로 새 파일 시스템 만들어줘. Windows 호환성 필요하고, 저장 용량은 1TB로 해줘.',
      userName: 'Eve',
      hashtags: 'Amazon FSx|Windows Compatibility',
    },
    {
      id: 29,
      prompt: "VPC 내에 새로운 서브넷 만들어줘. CIDR은 '10.0.2.0/24'로 설정해.",
      userName: 'Frank',
      hashtags: 'Amazon VPC|Subnet',
    },
    {
      id: 30,
      prompt:
        'AWS Direct Connect로 온프레미스 네트워크와 AWS 간 직접 연결 설정해줘.',
      userName: 'Grace',
      hashtags: 'AWS Direct Connect',
    },
    {
      id: 1,
      prompt:
      ...
      userName: 'Alice',
      hashtags: 'AWS Database Migration Service|Amazon Redshift|Amazon FSx',
    },
    {
      id: 2,
      prompt:
      ...
      userName: 'Jack',
      hashtags: 'Amazon DynamoDB|AWS Lambda',
    },
    {
      id: 3,
      prompt:
        'Amazon RDS 인스턴스를 생성해주세요. 엔진은 MySQL, 크기는 20GB, 멀티 AZ는 활성화해주세요.',
      userName: 'Eve',
      hashtags: 'Amazon EC2|Amazon FSx|Amazon DynamoDB|Amazon CloudFront',
    },
    {
      id: 4,
      prompt:
      ...
      userName: 'Alice',
      hashtags:
        'Amazon Elastic File System|Amazon VPC|Amazon Redshift|Amazon CloudFront|Amazon Aurora',
    },
    {
      id: 5,
      prompt:
      ...
      userName: 'Hank',
      hashtags:
        'Amazon Aurora|Amazon ECS|Amazon DynamoDB|Amazon Elastic File System',
    },
    {
      id: 6,
      prompt:
      ...
      userName: 'Eve',
      hashtags: 'Amazon VPC|Amazon Aurora|Amazon EC2|Amazon Lightsail',
    },
    {
      id: 7,
      prompt:
      ...
      userName: 'Alice',
      hashtags: 'Amazon VPC|Amazon EKS',
    },
    {
      id: 8,
      prompt:
      ...
      userName: 'Ivy',
      hashtags: 'AWS Database Migration Service|Amazon Elastic File System',
    },
    {
      id: 9,
      prompt:
        "Amazon DynamoDB 테이블을 생성해주세요. 테이블 이름은 'UserData'이며, 주 키는 'UserId'입니다.",
      userName: 'Bob',
      hashtags: 'Amazon EC2|AWS Storage Gateway|AWS Batch|Amazon Route 53',
    },
    {
      id: 10,
      prompt:
        'Amazon Route 53 호스팅 영역을 생성하고, mydomain.com을 위한 DNS 레코드를 설정해주세요.',
      userName: 'Jack',
      hashtags: 'Amazon EKS|AWS Fargate|AWS Storage Gateway|AWS Lambda',
    },
  ];
